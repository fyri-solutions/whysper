...
4) Open Chrome on your computer and go to `chrome://inspect/#devices`.
  ...
  - Click the "Port forwarding..." button and type "6060" into the "Port" input and "localhost:6060" into the "IP address and port" input, then press "Done".
  - Enter `http://localhost:6060` in the "Open tab with url" input and click the "Open" button.
